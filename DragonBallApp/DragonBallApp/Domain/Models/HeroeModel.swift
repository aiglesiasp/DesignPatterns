...
typealias HeroesModel = [HeroeModel]
...
let sampleHeroesData: HeroesModel = [
    HeroeModel(image: "roshi.jpg",
               isVilain: false,
               name: "MAESTRO ROSHI",
    ...
    HeroeModel(image: "vegeta.jpg",
               isVilain: false,
               name: "VEGETA",
               id: "6E1B907C-EB3A-45BA-AE03-44FA251F64E9v",
    ...
    HeroeModel(image: "androide17.jpg",
               isVilain: true,
               name: "ANDROIDE 17",
